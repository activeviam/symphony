defmodule SymphonyElixir.CoreTest do
  ...
  test "normal worker exit schedules active-state continuation retry" do
    ...
    assert_due_after(due_at_ms, sent_at_ms, 1_000, 2_000)
  end
  ...
  test "abnormal worker exit increments retry attempt progressively" do
    ...
    assert_due_after(due_at_ms, sent_at_ms, 40_000, 41_000)
  end
  ...
  test "first abnormal worker exit waits before retrying" do
    ...
    assert_due_after(due_at_ms, sent_at_ms, 10_000, 11_000)
  end
  ...
  defp assert_due_after(due_at_ms, sent_at_ms, min_delay_ms, max_delay_ms) do
    scheduled_delay_ms = due_at_ms - sent_at_ms
